...
public class Speed extends LunixEnchant {

    public Speed() {
        super("Speed", EnchantType.SPEED, List.of("Gives you permanent Speed", "while holding your pickaxe."), 3, CurrencyType.TOKENS,   true);
    }
