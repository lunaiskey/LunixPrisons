...
import static io.github.lunaiskey.lunixprison.gangs.GangManager.GANG_FILE_NAME;
...
public class Gang {
    ...
    public void save() {
        File file = new File(LunixPrison.getPlugin().getDataFolder() + "/"+GANG_FILE_NAME+"/" + uuid + ".yml");
